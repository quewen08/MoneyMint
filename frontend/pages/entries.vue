    ...
    <div class="flex justify-between items-center mb-6">
      ...
      <div v-else class="space-y-6">
        ...
        >
          ...
          <!-- 交易描述 -->
          <div v-if="entry.narration" class="ml-4 mb-3 text-sm text-gray-700">
          ...
          <div v-if="entry.type === 'Transaction'" class="ml-4 space-y-2">
            <div
              ...
              :key="index"
              class="flex justify-between items-center p-2 rounded bg-gray-50 hover:bg-gray-100 transition-colors"
            >
              <span class="text-sm font-medium">{{ posting.account }}</span>
          ...
          <!-- 账户记录详情 -->
          <div v-if="entry.type === 'Open'" class="ml-4 p-3 rounded bg-gray-50">
            <span class="text-sm font-medium">打开账户: {{ entry.account }}</span>
          </div>
        </div>
      </div>
